...
export function openOrderForm(order, cust) {
  ...
  const css = '@page{size:A4;margin:8mm;}*{box-sizing:border-box;}body{font-family:Arial,Helvetica,sans-serif;color:#0d2818;margin:0;padding:4px;font-size:10px;}'
    ...
    + '.off-item{break-inside:avoid;display:flex;align-items:center;gap:4px;padding:0.5px 0;}.off-nm{flex:1;min-width:0;font-size:11px;line-height:1.15;border:1px solid #e2e5e9;border-radius:2px;padding:0 3px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}.off-no{color:#15662f;}'
