...
| `js/store.js` | ALL data: catalogue, buy list, auth, Firebase REST, local mirrors, pub/sub | `initCatalog, catalog, categories, searchCatalog, buy, auth, pull, patch, customers, orders, tiers, runs, runById, saveRun, deliveryInfo, saveCustomer, saveOrder, ensureOpenOrder, tierPrice, bus` |
